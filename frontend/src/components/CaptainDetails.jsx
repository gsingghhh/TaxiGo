    ...
    <div>
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-start gap-4">
            ...
            <h3 className="text-lg font-medium">{captain?.fullName.firstName} {captain?.fullName.lastName}</h3>
          </div>
          <div>
        ...
        <div className="flex bg-yellow-400 p-4 rounded-3xl mt-8 justify-center gap-5 items-start">
          <div className="text-center">
            <i className="text-2xl font-thin ri-time-line"></i>
            <h5 className="text-lg font-medium">10.2</h5>
            <p className="text-sm text-white -mt-1">hours online </p>
          </div>
          <div className="text-center">
